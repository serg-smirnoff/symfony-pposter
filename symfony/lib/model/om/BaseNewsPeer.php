...
/**
 * Base static class for performing query and update operations on the 'pp_news' table.
 *
 * 
 *
...
abstract class BaseNewsPeer {
	...
	const META_ID = 'pp_news.META_ID';

	/** the column name for the TITLE field */
	const TITLE = 'pp_news.TITLE';

	/** the column name for the ANNOUNCE field */
	const ANNOUNCE = 'pp_news.ANNOUNCE';

	/** the column name for the TEXT field */
	const TEXT = 'pp_news.TEXT';

	/** the column name for the ORD field */
	const ORD = 'pp_news.ORD';

	/** the column name for the IS_ACTIVE field */
	const IS_ACTIVE = 'pp_news.IS_ACTIVE';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'pp_news.CREATED_AT';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NewsPeer::META_ID);

		$criteria->addSelectColumn(NewsPeer::TITLE);

		$criteria->addSelectColumn(NewsPeer::ANNOUNCE);

		$criteria->addSelectColumn(NewsPeer::TEXT);

		$criteria->addSelectColumn(NewsPeer::ORD);
	...
	public static function doCountJoinMeta(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(NewsPeer::META_ID,), array(MetaPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of News objects pre-filled with their Meta objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseNewsPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseNewsPeer', $c, $con);
		...
		$c->addJoin(array(NewsPeer::META_ID,), array(MetaPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (News) to $obj2 (Meta)
				$obj2->addNews($obj1);
      ...
      call_user_func($callable, 'BaseNewsPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (News) to the collection in $obj2 (Meta)
				$obj2->addNews($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the pp_news table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
