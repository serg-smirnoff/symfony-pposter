...
/**
 * Base class that represents a row from the 'pp_articles' table.
 *
 * 
 *
...
abstract class BaseArticles extends BaseObject  implements Persistent {
  ...
  const PEER = 'ArticlesPeer';
	...
	/**
	 * Initializes internal state of BaseArticles object.
	 * @see        applyDefaults()
	 */
	...
	public function setMetaId($v)
	{
		...
		if ($this->meta_id !== $v) {
			$this->meta_id = $v;
			$this->modifiedColumns[] = ArticlesPeer::META_ID;
		}
	...
	public function setAnnounce($v)
	{
		...
		if ($this->announce !== $v) {
			$this->announce = $v;
			$this->modifiedColumns[] = ArticlesPeer::ANNOUNCE;
		}
	...
	public function setText($v)
	{
		...
		if ($this->text !== $v) {
			$this->text = $v;
			$this->modifiedColumns[] = ArticlesPeer::TEXT;
		}
	...
	public function setOrd($v)
	{
		...
		if ($this->ord !== $v) {
			$this->ord = $v;
			$this->modifiedColumns[] = ArticlesPeer::ORD;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $v === false) {
			$this->is_active = $v;
			$this->modifiedColumns[] = ArticlesPeer::IS_ACTIVE;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ArticlesPeer::CREATED_AT;
			}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ArticlesPeer::IS_ACTIVE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->announce = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->text = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->ord = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 8; // 8 = ArticlesPeer::NUM_COLUMNS - ArticlesPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(ArticlesPeer::CREATED_AT))
    {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArticlesPeer::META_ID)) $criteria->add(ArticlesPeer::META_ID, $this->meta_id);
		if ($this->isColumnModified(ArticlesPeer::TITLE)) $criteria->add(ArticlesPeer::TITLE, $this->title);
		if ($this->isColumnModified(ArticlesPeer::ANNOUNCE)) $criteria->add(ArticlesPeer::ANNOUNCE, $this->announce);
		if ($this->isColumnModified(ArticlesPeer::TEXT)) $criteria->add(ArticlesPeer::TEXT, $this->text);
		if ($this->isColumnModified(ArticlesPeer::ORD)) $criteria->add(ArticlesPeer::ORD, $this->ord);
		if ($this->isColumnModified(ArticlesPeer::IS_ACTIVE)) $criteria->add(ArticlesPeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(ArticlesPeer::CREATED_AT)) $criteria->add(ArticlesPeer::CREATED_AT, $this->created_at);
