...
/**
 * Base class that represents a row from the 'pp_news' table.
 *
 * 
 *
...
abstract class BaseNews extends BaseObject  implements Persistent {
  ...
  const PEER = 'NewsPeer';
	...
	public function setMetaId($v)
	{
		...
		if ($this->meta_id !== $v) {
			$this->meta_id = $v;
			$this->modifiedColumns[] = NewsPeer::META_ID;
		}
	...
	public function setAnnounce($v)
	{
		...
		if ($this->announce !== $v) {
			$this->announce = $v;
			$this->modifiedColumns[] = NewsPeer::ANNOUNCE;
		}
	...
	public function setOrd($v)
	{
		...
		if ($this->ord !== $v) {
			$this->ord = $v;
			$this->modifiedColumns[] = NewsPeer::ORD;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::META_ID)) $criteria->add(NewsPeer::META_ID, $this->meta_id);
		if ($this->isColumnModified(NewsPeer::TITLE)) $criteria->add(NewsPeer::TITLE, $this->title);
		if ($this->isColumnModified(NewsPeer::ANNOUNCE)) $criteria->add(NewsPeer::ANNOUNCE, $this->announce);
		if ($this->isColumnModified(NewsPeer::TEXT)) $criteria->add(NewsPeer::TEXT, $this->text);
		if ($this->isColumnModified(NewsPeer::ORD)) $criteria->add(NewsPeer::ORD, $this->ord);
