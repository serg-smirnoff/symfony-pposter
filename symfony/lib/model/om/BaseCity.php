...
abstract class BaseCity extends BaseObject  implements Persistent {
  ...
  const PEER = 'CityPeer';
	...
	public function setParentId($v)
	{
		...
		if ($this->parent_id !== $v) {
			$this->parent_id = $v;
			$this->modifiedColumns[] = CityPeer::PARENT_ID;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $v === 0) {
			$this->is_active = $v;
			$this->modifiedColumns[] = CityPeer::IS_ACTIVE;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(CityPeer::IS_ACTIVE))) {
				return false;
			}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CityPeer::PARENT_ID)) $criteria->add(CityPeer::PARENT_ID, $this->parent_id);
		if ($this->isColumnModified(CityPeer::NAME)) $criteria->add(CityPeer::NAME, $this->name);
		if ($this->isColumnModified(CityPeer::IS_ACTIVE)) $criteria->add(CityPeer::IS_ACTIVE, $this->is_active);
