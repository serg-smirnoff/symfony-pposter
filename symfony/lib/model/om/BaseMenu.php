...
/**
 * Base class that represents a row from the 'pp_menu' table.
 *
 * 
 *
...
abstract class BaseMenu extends BaseObject  implements Persistent {
  ...
  const PEER = 'MenuPeer';
	...
	public function setAnnounce($v)
	{
		...
		if ($this->announce !== $v) {
			$this->announce = $v;
			$this->modifiedColumns[] = MenuPeer::ANNOUNCE;
		}
	...
	public function setText($v)
	{
		...
		if ($this->text !== $v) {
			$this->text = $v;
			$this->modifiedColumns[] = MenuPeer::TEXT;
		}
	...
	public function setOrd($v)
	{
		...
		if ($this->ord !== $v) {
			$this->ord = $v;
			$this->modifiedColumns[] = MenuPeer::ORD;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(MenuPeer::IS_ACTIVE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->announce = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->text = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->ord = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setAnnounce($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setText($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setOrd($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuPeer::ANNOUNCE)) $criteria->add(MenuPeer::ANNOUNCE, $this->announce);
		if ($this->isColumnModified(MenuPeer::TEXT)) $criteria->add(MenuPeer::TEXT, $this->text);
		if ($this->isColumnModified(MenuPeer::ORD)) $criteria->add(MenuPeer::ORD, $this->ord);
