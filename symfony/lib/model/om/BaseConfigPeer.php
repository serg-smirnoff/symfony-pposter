...
/**
 * Base static class for performing query and update operations on the 'pp_config' table.
 *
 * 
 *
...
abstract class BaseConfigPeer {
	...
	const PARAM = 'pp_config.PARAM';

	/** the column name for the VALUE field */
	const VALUE = 'pp_config.VALUE';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'pp_config.DESCRIPTION';

	/** the column name for the IS_ACTIVE field */
	const IS_ACTIVE = 'pp_config.IS_ACTIVE';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'pp_config.CREATED_AT';

	/** the column name for the ID field */
	const ID = 'pp_config.ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Param', 'Value', 'Description', 'IsActive', 'CreatedAt', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('param', 'value', 'description', 'isActive', 'createdAt', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::PARAM, self::VALUE, self::DESCRIPTION, self::IS_ACTIVE, self::CREATED_AT, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('param', 'value', 'description', 'is_active', 'created_at', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Param' => 0, 'Value' => 1, 'Description' => 2, 'IsActive' => 3, 'CreatedAt' => 4, 'Id' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('param' => 0, 'value' => 1, 'description' => 2, 'isActive' => 3, 'createdAt' => 4, 'id' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::PARAM => 0, self::VALUE => 1, self::DESCRIPTION => 2, self::IS_ACTIVE => 3, self::CREATED_AT => 4, self::ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('param' => 0, 'value' => 1, 'description' => 2, 'is_active' => 3, 'created_at' => 4, 'id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ConfigMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseConfigPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseConfigPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseConfigPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseConfigPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseConfigPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseConfigPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseConfigPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseConfigPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseConfigPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseConfigPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseConfigPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseConfigPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the pp_config table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
...
//
// NOTE: This static code cannot call methods on the ConfigPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ConfigPeer class:
//
// Propel::getDatabaseMap(ConfigPeer::DATABASE_NAME)->addTableBuilder(ConfigPeer::TABLE_NAME, ConfigPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseConfigPeer::DATABASE_NAME)->addTableBuilder(BaseConfigPeer::TABLE_NAME, BaseConfigPeer::getMapBuilder());
