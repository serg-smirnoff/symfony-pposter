...
/**
 * Base class that represents a row from the 'pp_config' table.
 *
 * 
 *
...
abstract class BaseConfig extends BaseObject  implements Persistent {
  ...
  const PEER = 'ConfigPeer';
	...
	public function setParam($v)
	{
		...
		if ($this->param !== $v) {
			$this->param = $v;
			$this->modifiedColumns[] = ConfigPeer::PARAM;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $v === false) {
			$this->is_active = $v;
			$this->modifiedColumns[] = ConfigPeer::IS_ACTIVE;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ConfigPeer::IS_ACTIVE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->param = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setParam($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConfigPeer::PARAM)) $criteria->add(ConfigPeer::PARAM, $this->param);
		...
		if ($this->isColumnModified(ConfigPeer::IS_ACTIVE)) $criteria->add(ConfigPeer::IS_ACTIVE, $this->is_active);
