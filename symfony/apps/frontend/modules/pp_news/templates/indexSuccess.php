...
<div id="items">
<div id="itemsInner">
<div id="bc"><a href="http://p-poster.com" title="Главная">Главная</a>&nbsp;/&nbsp;Новости</div>
<?php if ($pager->getLinks()) {?>
<div class="paginator">
<?php foreach ($pager->getLinks() as $page){ ?>
<div class="page"><a href="http://p-poster.com/news/?page=<?php echo $page;?>" <?php if ($page == $pager->getPage()) { echo "id=\"active\""; }?>><?php echo $page; ?></a></div>
<?php }?>
</div>
<div class="clear"></div>
<?php }?>
...
<table>
	<tr>
		...
		<td>&nbsp;&nbsp;</td>
		<td><a href="http://p-poster.com/news/id/<?php echo $item->getId();?>" title="<?php echo $item->getTitle(); ?>"><?php echo $item->getTitle(); ?></a></td>
	</tr>
	<tr>
		<td></td>
		<td>&nbsp;&nbsp;</td>
