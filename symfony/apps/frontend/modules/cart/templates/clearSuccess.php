...
<div id="items">
<div id="itemsInner">
<div id="bc"><a href="http://p-poster.com" title="Главная">Главная</a>&nbsp;/&nbsp;<a href="http://p-poster.com/cart" title="Корзина">Корзина</a>&nbsp;/&nbsp;Очистить корзину</div>
	<div>Вы очистили Корзину. В корзине 0 постеров.</div>
</div>
</div>
</div>
