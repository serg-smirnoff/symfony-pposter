...
<div id="items">
<div id="itemsInner">
<div id="bc"><a href="http://p-poster.com" title="Главная">Главная</a>&nbsp;/&nbsp;<a href="http://p-poster.com/articles/" title="Статьи">Статьи</a>&nbsp;/&nbsp;<?php echo $new->getTitle(); ?></div>
<div>
	<div><?php echo $new->getText(); ?></div>
	<br />
	<div><a href="http://p-poster.com/articles/" title="Все статьи">Все статьи</a></div>
</div>
</div>
<div class="clear"></div>
</div>
